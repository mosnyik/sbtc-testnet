  ...
  return (
    <form className="flex items-center justify-center space-x-4">
      <input
        ...
        className="w-1/3 px-4 py-2 text-gray-800 bg-gray-300  rounded focus:outline-none focus:border-orange-500"
        value={satoshis}
...
//   const signMessage = async (e) => {
//     e.preventDefault();
//         console.log('btc address', userData.profile.btcAddress.p2wpkh.testnet)
